...
with st.expander("How to use?"):    # Element 1
    st.markdown('<div class="disclaimer">'
                ...
                " on: <b><a href='https://better.streamlit.app/' style='color:green;'>https://better.streamlit.app/</a></b>"
                '</div>',
...
with st.expander("Legal Info"):  # Element 5
    st.write("<br><a href='https://linktr.ee/arm_andreasian_' style='color:yellow;'>Armen-Jean Andreasian</a> <br>Free Apps for All © 2023", unsafe_allow_html=True)
